...
{
    public function __construct(protected SettingsRepositoryInterface $settings, protected Dispatcher $events, protected SignatureValidator $validator, protected SignatureFormatter $formatter)
    {
    }
